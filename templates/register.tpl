...
<div class="row register">
    <button onclick="window.location.href='https://one.forumias.com/?registersource=quest'" class="btn btn-primary btn-lg btn-block" id="Register" type="button">Register</button>
	<div class="{register_window:spansize}">
		<div class="register-block hidden">
