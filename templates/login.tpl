...
<div class="row">
	<!-- IF allowLocalLogin -->
	<button class="btn btn-primary btn-lg btn-block" onclick="window.location.href='https://one.forumias.com/login.php?loginsource=quest'" id="login" type="button">Login</button>
